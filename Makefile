...
$(OUTPUT_MATROSKA).md: index_matroska.md diagram.md matroska_schema_section_header.md ebml_matroska_elements4rfc.md ordering.md chapters.md attachments.md cues.md streaming.md notes.md matroska_deprecated4rfc.md rfc_backmatter_matroska.md
	cat $^ | sed -e '/^---/,/^---/d' \
